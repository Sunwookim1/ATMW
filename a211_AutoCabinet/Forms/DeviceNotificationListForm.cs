...
namespace ATMW.Forms
{
    public partial class DeviceNotificationListForm : Form
    {
        ...
        private void RequestJSON()
        {
            ...
            Uri uri = new Uri(ApiDefinit.ApiUri + "/mwCon/getDeviceList");
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (CheckSelectedItem)
            {
                ...
                SelectedDeviceItem(DeviceName, DeviceId, ApiDefinit.ApiUri, ApiDefinit.GsUri, NetWorkMode);
        ...
        {
            ApiDefinit.ApiUri = "http://" + ApiUriTextValue.Text;
            ApiDefinit.GsUri = "http://" + GsUriTextValue.Text;
        ...
        private void ApiUriTextValue_TextChanged(object sender, EventArgs e)
        {
